...
public class WarmUp {
	...
	public static void main(String[] args) {
		 302
		 80
		 :muscle: No negativity Here :muscle:
		 :female-technologist::male-technologist:Only Hard Work , Dedication and Ambition :rocket:
		 -Leonidus
		 ...
		 Message List
		 Jump
		 729 new messages since 10:19 AM on March 24th
		 Mark as read

		 Omer F Ugurlu [11:28 AM]
		 no
